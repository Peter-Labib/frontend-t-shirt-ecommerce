...
const CreateUser = () => {
  ...
  return (
    <form
      ...
      className='bg-white shadow-md p-4 sm:mt-6 md:mt-10 md:max-w-lg lg:max-w-xl mx-auto rounded-lg'
    >
      <h3 className='font-medium text-gray-800'>Personal Information</h3>
      <div className='grid grid-cols-6 gap-6 w-full my-5 rounded-md p-4'>
        <div className='col-span-6 sm:col-span-3'>
          ...
          <input
            ...
            className={`sign_input ${
              errors.firstName ? 'focus:ring-red-400' : 'focus:ring-indigo-500'
            }`}
            dir='auto'
          />
